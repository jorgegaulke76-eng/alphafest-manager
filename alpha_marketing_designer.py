"""HF53.2-HF5-HF7 — Designer Comercial Mestre AlphaFest • Aprovação Final Comercial.
...
def build_design_plan(product: dict[str, Any], objective: str = "Vender", campaign: str = "", channels: list[str] | None = None) -> dict[str, Any]:
    ...
    # HF53.2-HF5-HF7: mantém o título inteligente e adiciona QA visual final sem mudar a lógica comercial.
