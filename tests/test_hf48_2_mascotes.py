...
def test_hf482_mascotes_sao_opt_in_e_embutidos_so_na_previa_especifica():
    ...
    assert "PRÉVIA INTERNA HF51.1-HF2" in hf482
...
def test_hf482_ativos_existem_e_manager_prepara_sob_demanda():
    ...
    assert '"🛍️ Vitrine limpa + Ficha comercial do produto — HF51.1-HF2"' in app
    assert '"🛍️ Preparar / atualizar HF51.1-HF2"' in app
