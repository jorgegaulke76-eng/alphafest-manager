...
def test_hf53_3_hf1_version():
    assert Path('VERSAO.txt').read_text(encoding='utf-8').strip() == '20.4.9-I8.13.5-HF53.3-HF1'
...
def test_anna_social_is_second_protected_template_in_validation():
    ...
    assert anna['versao_template'] == 'HF53.3-HF1'
...
def test_ui_exposes_native_network_sizes_and_validation_state():
    ...
    assert 'Designer Comercial AlphaFest HF53.3-HF1' in app
