...
.afc65-copy{{display:flex;flex-direction:column;gap:6px;padding:16px 20px 4px;text-align:center;color:#0f376c}}.afc65-copy strong{{font-size:24px;flex:0 0 auto}}.afc65-copy span{{display:block;font-size:15px;line-height:1.45;color:#51677f;max-height:96px;overflow-y:auto;overscroll-behavior:contain;scrollbar-gutter:stable;padding:0 8px 0 4px;scrollbar-width:thin;scrollbar-color:#f3c61d rgba(15,55,108,.10)}}.afc65-copy span::-webkit-scrollbar{{width:8px}}.afc65-copy span::-webkit-scrollbar-track{{background:rgba(15,55,108,.08);border-radius:999px}}.afc65-copy span::-webkit-scrollbar-thumb{{background:#f3c61d;border-radius:999px;border:2px solid #fff}}
...
@media(max-width:620px){{#afc65-root:before{{background:rgba(8,37,74,.08)}}.afc65-card{{width:92vw;max-height:82vh;border-radius:20px}}.afc65-art{{max-height:68vh}}.afc65-copy{{padding:14px 14px 4px}}.afc65-copy strong{{font-size:20px}}.afc65-copy span{{font-size:14px;max-height:84px;padding-right:6px}}.afc65-close{{width:36px;height:36px;right:8px;top:8px}}.afc65-mascot{{display:none!important}}}}
