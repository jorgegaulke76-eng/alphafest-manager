"""Pacote público de produção do site AlphaFest (motor HF44 · visual aprovado HF48.3).
...
"""
    readme = f"""ALPHAFEST — PACOTE DE PRODUÇÃO HF48.3
...
- Publica o visual aprovado HF48.3 com cores AlphaFest e Thu + Fox.
