"""Pacote público de produção do site AlphaFest (motor HF44 · HF50.1-HF4 · visual HF48.3-HF4).
...
def gerar_pacote_producao(
    ...
    *,
    ...
    versao_manager: str = "20.4.9-I8.13.5-HF50.1-HF4",
) -> bytes:
...
"""
    readme = f"""ALPHAFEST — PACOTE DE PRODUÇÃO HF50.1-HF4
...
- Publica o HF50.1-HF4 · cabeçalho azul com marca oficial maior + carrossel comercial, preservando o visual HF48.3-HF4 com Thu + Fox.
