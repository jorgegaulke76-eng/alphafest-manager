...
/* HF50.1-HF4 — cabeçalho aprovado com marca horizontal grande + carrossel promocional compacto */
...
.header-in{max-width:1320px;padding:8px 24px;gap:22px;min-height:112px;overflow:visible}.brand{gap:0;min-height:96px;overflow:visible;flex:0 0 390px;display:flex;align-items:center}.brand-logo{width:380px;height:96px;object-fit:contain;object-position:left center;display:block;overflow:visible;filter:drop-shadow(0 5px 10px rgba(0,0,0,.14));border-radius:0}.brand-copy{display:none!important}
...
@media(max-width:1100px){.brand{flex-basis:320px}.brand-logo{width:312px;height:82px}.header-in{min-height:100px}.site-nav{top:100px}.hf50-carousel-slide{flex-basis:calc((100% - 28px)/3)}}
@media(max-width:900px){.brand{flex-basis:250px}.brand-logo{width:242px;height:70px}.header-in{min-height:88px}.site-nav{top:88px}.hf48-header-search{display:none}.hf50-carousel-slide{flex-basis:calc((100% - 14px)/2)}}
@media(max-width:620px){.header{background:linear-gradient(90deg,#0657aa,#087bd3)}.header-in{padding:5px 10px;min-height:70px;gap:8px}.brand{flex-basis:176px;min-height:60px}.brand-logo{width:172px;height:58px}.site-nav{top:70px}.site-nav-in{background:transparent}.hf50-carousel{padding:10px 10px 28px}.hf50-carousel-shell{border-radius:18px;padding:12px 42px 16px}.hf50-carousel-slide{flex-basis:100%;min-height:185px}.hf50-carousel-copy{padding:16px}.hf50-carousel-copy h2{font-size:22px}.hf50-carousel-arrow{width:34px;height:34px}.hf50-carousel-arrow.prev{left:5px}.hf50-carousel-arrow.next{right:5px}}
...
'''
    ...
    preview_rotulo = 'PRÉVIA INTERNA HF50.1-HF4 · CABEÇALHO APROVADO + CARROSSEL PROMOCIONAL · NÃO PUBLICADA' if usar_mascotes else 'PRÉVIA INTERNA HF48.1 · NOVO VISUAL COMERCIAL · NÃO PUBLICADA'
