"""HF48 — camada visual comercial do site AlphaFest (HF51.4-HF2 · base visual HF48.3-HF4).
...
'''
    ...
    preview_rotulo = 'PRÉVIA INTERNA HF51.4-HF2 · CABEÇALHO FINAL TRANSPARENTE + CARROSSEL PROMOCIONAL · NÃO PUBLICADA' if usar_mascotes else 'PRÉVIA INTERNA HF48.1 · NOVO VISUAL COMERCIAL · NÃO PUBLICADA'
