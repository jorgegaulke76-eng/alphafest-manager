...
/* HF50.1-HF7 — acabamento profissional: um único cabeçalho azul, sem efeito de banner empilhado */
...
/* HF50.1-HF7 — carrossel fixado exatamente entre o Hero e “Explore por categoria”. */
...
/* HF50.1-HF7 — cabeçalho final aprovado: marca transparente sobre um único azul, sem emendas */
...
'''
    ...
    preview_rotulo = 'PRÉVIA INTERNA HF50.1-HF7 · CABEÇALHO FINAL TRANSPARENTE + CARROSSEL PROMOCIONAL · NÃO PUBLICADA' if usar_mascotes else 'PRÉVIA INTERNA HF48.1 · NOVO VISUAL COMERCIAL · NÃO PUBLICADA'
