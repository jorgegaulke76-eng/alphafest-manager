...
/* HF51.1-HF2 — categorias já ficam na seção superior; evita repetição e overflow na vitrine. */
...
/* HF51.1-HF2 — acabamento profissional: um único cabeçalho azul, sem efeito de banner empilhado */
...
/* HF51.1-HF2 — carrossel fixado exatamente entre o Hero e “Explore por categoria”. */
...
/* HF51.1-HF2 — cabeçalho final aprovado: marca transparente sobre um único azul, sem emendas */
...
'''
    ...
    preview_rotulo = 'PRÉVIA INTERNA HF51.1-HF2 · CABEÇALHO FINAL TRANSPARENTE + CARROSSEL PROMOCIONAL · NÃO PUBLICADA' if usar_mascotes else 'PRÉVIA INTERNA HF48.1 · NOVO VISUAL COMERCIAL · NÃO PUBLICADA'
...
(function(){
  ...
  // HF51.1-HF2 — carrossel em loop infinito real: autoplay sempre avança no mesmo sentido.
  ...
  // HF51.1-HF2 — menu mobile enxuto: 4 destinos principais + “Mais”.
