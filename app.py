...
def dialog_thu_importar_imagens_site(pagina):
    ...
    sugestao = thu_site_sugerir_produto(
        ...
        catalogo,
        alternativas=[
            pagina.get("texto_menu", ""),
            pagina.get("titulo_html", ""),
            *(pagina.get("headings") or [])[:5],
        ],
    )
