...
EMBEDDED_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "anna_social_redes": {
        ...
        "versao_template": "HF53.3-HF8-HF9",
        "oficial": False,
        "protegido": True,
        "autopilot_aprovado": True,
...
def render_template(
    ...
    *,
    ...
    if str(cfg.get("id")) == "splash_premium_anna" and str(cfg.get("source")) != "library":
        ...
        # HF53.3-HF8-HF9: renderer Anna independente com acabamento visual aprovado para validação no Manager. Não reutiliza o compositor
