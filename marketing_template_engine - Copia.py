...
EMBEDDED_TEMPLATES: dict[str, dict[str, Any]] = {
    ...
    "anna_social_redes": {
        ...
        "descricao": "Template Anna Prompt Premium HF8-HF3: renderer independente com Feed 1080×1080 e refino comercial de hierarquia. Logo splash com presença real, manchete forte sem esmagar o corpo, produto protagonista com recorte assistido quando possível, benefícios maiores, vitrine de aplicações e CTA WhatsApp dominante. Story/Status e horizontal preservam a linguagem do Feed.",
        "categoria_template": "Redes Sociais",
        "status_template": "Em validação",
        "versao_template": "HF53.3-HF8-HF3",
        "oficial": False,
        "protegido": True,
        "autopilot_aprovado": True,
...
def _render_anna_social_native(
    ...
    *,
    ...
    """HF53.3-HF8-HF3 — Template Anna Prompt Premium, com grade comercial fixa baseada na grade editorial aprovada.
    ...
    def decorate():
        # HF53.3-HF8-HF3: linguagem visual fixa do prompt premium. O fundo deixa de parecer uma
...
def render_template(
    ...
    *,
    ...
    if str(cfg.get("id")) == "splash_premium_anna" and str(cfg.get("source")) != "library":
        ...
        # HF53.3-HF8-HF3: renderer Anna realmente independente. Não reutiliza o compositor
